...
Fields or variants of record type of the fixed part or
...
must be used to access it. If a name of an inlined field or variant
is not unique, the first match in field and variant order is selected.
