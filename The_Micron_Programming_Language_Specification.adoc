...
|*Systems* 
|Drivers/Kernels 
|Stack Frames, Recursion, *VLA*, *Static Bound Procedures*. EXTERN allowed.
...
Level 1 in addition has EXTERN
procedures.

Level 1 in addition supports variable length arrays (VLA).
