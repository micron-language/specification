...
NOTE: Whether an identifier is _public_, _readonly_ or _private_ is called its _visibility_. The default visibility of an identifier
  can be changed from _private_ to something else using the <<Visibility>> module attribute. 
...
|FLT32, F4, REAL |32 bit |an IEEE 754 floating point number
|FLT64, F8, LONGREAL |64 bit |an IEEE 754 floating point number
